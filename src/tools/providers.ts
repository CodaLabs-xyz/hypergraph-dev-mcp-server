...
export async function handleSetupProviders(args: any) {
...
function generateReactProviderCode(
  providerType: string,
  includeAuth: boolean,
  includeCustomHooks: boolean,
  appName: string
...
function generateAppProviderCode(includeAuth: boolean, appName: string) {
...
function generateMainProviderWrapper(providerType: string, includeAuth: boolean, appName: string) {
...
function generateCustomHooks(providerType: string, includeAuth: boolean) {
...
function generateProviderUsageExamples(providerType: string, appName: string) {
...
function generateTypescriptProviderCode(
  providerType: string,
  includeAuth: boolean,
  includeCustomHooks: boolean,
  appName: string
