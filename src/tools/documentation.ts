...
export async function handleGetDocumentation(args: any) {
...
function generateDocumentation(topic: string, format: string, includeExamples: boolean, language: string) {
  let documentation = '';
...
function generateOverviewDocs(format: string, includeExamples: boolean, language: string) {
...
function generateQuickstartDocs(format: string, includeExamples: boolean, language: string) {
...
function generateCoreConceptsDocs(format: string, includeExamples: boolean, language: string) {
...
function generateBestPracticesDocs(format: string, includeExamples: boolean, language: string) {
...
function generateTroubleshootingDocs(format: string, includeExamples: boolean, language: string) {
...
function generateAPIReferenceDocs(format: string, includeExamples: boolean, language: string) {
...
function generateAuthenticationDocs(format: string, includeExamples: boolean, language: string) {
  return `# Authentication Documentation\n\nAuthentication setup with Geo Connect...`;
}

function generateSpacesDocs(format: string, includeExamples: boolean, language: string) {
  return `# Spaces Documentation\n\nManaging public and private spaces...`;
}

function generateSchemaDocs(format: string, includeExamples: boolean, language: string) {
  return `# Schema Documentation\n\nDefining entities and relationships...`;
}

function generateQueriesDocs(format: string, includeExamples: boolean, language: string) {
  return `# Queries Documentation\n\nQuerying private and public data...`;
}

function generateProvidersDocs(format: string, includeExamples: boolean, language: string) {
  return `# Providers Documentation\n\nSetting up React providers...`;
}

function generateMappingDocs(format: string, includeExamples: boolean, language: string) {
  return `# Mapping Documentation\n\nConnecting to the Knowledge Graph...`;
}

function generatePublishingDocs(format: string, includeExamples: boolean, language: string) {
  return `# Publishing Documentation\n\nPublishing data to the Knowledge Graph...`;
}

function generateKeyFeaturesDocs(format: string, includeExamples: boolean, language: string) {
