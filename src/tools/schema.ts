...
export async function handleCreateSchema(args: any) {
...
function generateExampleUsage(entityName: string, properties: any[], relations: any[]) {
...
function generateValidationHelpers(entityName: string, properties: any[]) {
