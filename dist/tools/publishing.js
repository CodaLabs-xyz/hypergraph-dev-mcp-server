...
export async function handleCreatePublishingFlow(args) {
    const { entityType, publishingStrategy, includeValidation, includePreview, framework, batchSize } = args;
    const publishingCode = generatePublishingCode(entityType, publishingStrategy, includeValidation, includePreview, framework, batchSize);
    return {
        content: [
            {
                type: 'text',
...
function generatePublishingCode(entityType, publishingStrategy, includeValidation, includePreview, framework, batchSize) {
    ...
    if (framework === 'react') {
        publishingCode += generateReactPublishingCode(capitalizedType, publishingStrategy, includeValidation, includePreview, batchSize);
    }
    else if (framework === 'typescript') {
        publishingCode += generateTypescriptPublishingCode(capitalizedType, publishingStrategy, includeValidation, includePreview, batchSize);
    }
    else {
        publishingCode += generateVanillaJSPublishingCode(capitalizedType, publishingStrategy, includeValidation, includePreview, batchSize);
    }
    return publishingCode;
}
function generateReactPublishingCode(entityType, publishingStrategy, includeValidation, includePreview, batchSize) {
...
function generateImmediatePublishing(entityType, includeValidation, includePreview) {
...
function generateBatchPublishing(entityType, includeValidation, includePreview, batchSize) {
...
function generateScheduledPublishing(entityType, includeValidation, includePreview) {
...
function generateConditionalPublishing(entityType, includeValidation, includePreview) {
...
function generateValidationFunctions(entityType) {
    let code = `\n  // Validation functions\n`;
...
function generatePreviewFunctions(entityType) {
    let code = `\n  // Preview functions\n`;
...
function generatePublishingUI(entityType, publishingStrategy, includeValidation, includePreview) {
    let code = `\n  return (\n`;
...
function generateImmediateUI(entityType, includeValidation, includePreview) {
...
function generateBatchUI(entityType) {
...
function generateScheduledUI(entityType) {
...
function generateConditionalUI(entityType) {
...
function generatePreviewModal(entityType) {
...
function generatePublishingCSS(entityType, publishingStrategy) {
...
function generateTypescriptPublishingCode(entityType, publishingStrategy, includeValidation, includePreview, batchSize) {
...
function generateTypescriptImmediatePublishing(entityType, includeValidation) {
...
function generateTypescriptBatchPublishing(entityType, includeValidation, batchSize) {
...
function generateTypescriptValidation(entityType) {
...
function generateVanillaJSPublishingCode(entityType, publishingStrategy, includeValidation, includePreview, batchSize) {
