...
function generateReactSpaceCode(spaceType, spaceName, description, includeInvitations) {
...
function generateTypescriptSpaceCode(spaceType, spaceName, description, includeInvitations) {
    return `// Hypergraph ${spaceType} Space: ${spaceName}
// ${description}
...
function generateVanillaJSSpaceCode(spaceType, spaceName, description, includeInvitations) {
    return `// Hypergraph ${spaceType} Space: ${spaceName}
// ${description}
