...
export async function handleGenerateQuickstart(args) {
    const { projectName, framework, entityTypes, includeAuth, includeExamples, useTypeScript } = args;
    const quickstartProject = generateQuickstartProject(projectName, framework, entityTypes, includeAuth, includeExamples, useTypeScript);
    return {
        content: [
            {
                type: 'text',
...
function generateQuickstartProject(projectName, framework, entityTypes, includeAuth, includeExamples, useTypeScript) {
...
function generateProjectStructure(projectName, framework, useTypeScript) {
...
function generatePackageJson(projectName, framework, useTypeScript) {
...
function generateConfigFiles(framework, useTypeScript) {
    let configs = '';
    if (useTypeScript) {
...
function generateSchemaFiles(entityTypes, useTypeScript) {
    const ext = useTypeScript ? 'ts' : 'js';
...
function generateEntitySchema(entityType, useTypeScript) {
...
function generateMappingFile(entityTypes, useTypeScript) {
    const ext = useTypeScript ? 'ts' : 'js';
...
function generateEntityMapping(entityType) {
...
function generateReactApp(projectName, entityTypes, includeAuth, includeExamples, useTypeScript) {
...
function generateLayoutComponent(projectName, entityTypes, includeAuth, useTypeScript) {
    const ext = useTypeScript ? 'tsx' : 'jsx';
...
function generateEntityListComponent(entityType, useTypeScript) {
    const ext = useTypeScript ? 'tsx' : 'jsx';
...
function generateEntityForm(entityType, useTypeScript) {
...
function generateEntityCard(entityType, useTypeScript) {
...
function generateAuthComponents(useTypeScript) {
    const ext = useTypeScript ? 'tsx' : 'jsx';
...
function generateNextjsApp(projectName, entityTypes, includeAuth, includeExamples, useTypeScript) {
...
function generateVanillaApp(projectName, entityTypes, includeAuth, includeExamples) {
    return `## Vanilla TypeScript App\n\nVanilla TypeScript implementation...\n\n`;
}
function generateExpressAPI(projectName, entityTypes, includeAuth, useTypeScript) {
    return `## Express API Server\n\nExpress.js API implementation...\n\n`;
}
function generateExampleContent(entityTypes, framework, useTypeScript) {
...
function generateExampleData(entityType) {
    if (entityType === 'Event') {
        return `{
...
function generateSetupInstructions(projectName, framework) {
