...
export async function handleGenerateQuery(args) {
...
function generateQueryCode(entityName, queryType, includeRelations, filters, spaceId, framework, includeExamples) {
...
function generateReactQueryCode(entityName, queryType, includeRelations, filters, spaceId, includeExamples) {
...
function generateSingleQuery(mode, entityName, includeRelations, filters, spaceId, indent) {
...
function getFilterValue(value, operator) {
...
function generateTypescriptQueryCode(entityName, queryType, includeRelations, filters, spaceId, includeExamples) {
...
function generateTypescriptMethod(mode, entityName, includeRelations, filters, spaceId) {
...
function generateVanillaJSQueryCode(entityName, queryType, includeRelations, filters, spaceId, includeExamples) {
...
function generateJSMethod(mode, entityName, includeRelations, filters, spaceId) {
...
function generateReactExamples(entityName, queryType, includeRelations, filters) {
...
function generateTypescriptExamples(entityName, queryType) {
...
function generateVanillaJSExamples(entityName, queryType) {
    let examples = `// Usage Examples\n\n`;
